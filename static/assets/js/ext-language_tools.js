...
function(e, t, n) {
    ...
    c = function() {
        ...
        this.parseSnippetFile = function(e) {
            ...
            while (i = r.exec(e)) {
                ...
                if (i[4]) n.content = i[4].replace(/^\t/gm, ""),
                t.push(n),
                n = {};
                else {
                    var o = i[2],
    ...
    var m = e("./editor").Editor; (function() {
...
function(e, t, n) {
    ...
    l = function(e) {
        ...
        return d.$tokenizeRow = function(e) {
            ...
            var i = -1,
            s, o;
            for (var u = 0; u < t.caption.length; u++) o = t.caption[u],
        ...
        n.show = function(e, t, r) {
            ...
            c = l > o / 2 && !r;
            c && l + t + f > o ? (a.$maxPixelHeight = l - 2 * this.$borderSize, s.style.top = "", s.style.bottom = o - l + "px", n.isTopdown = !1) : (l += t, a.$maxPixelHeight = o - l - .2 * t, s.style.top = l + "px", s.style.bottom = "", n.isTopdown = !0),
            s.style.display = "",
...
function(e, t, n) {
    ...
    t.getCompletionPrefix = function(e) {
        ...
        return e.completers.forEach(function(e) {
            e.identifierRegexps && e.identifierRegexps.forEach(function(e) { ! r && e && (r = this.retrievePrecedingIdentifier(n, t.column, e))
            }.bind(this))
        }.bind(this)),
    ...
    l = function() {
        ...
        this.insertMatch = function(e, t) {
            ...
            if (e.completer && e.completer.insertMatch) e.completer.insertMatch(this.editor, e);
                ...
                if (this.completions.filterText) {
                    ...
                    for (var r = 0,
                    i; i = n[r]; r++) i.start.column -= this.completions.filterText.length,
        ...
        this.gatherCompletions = function(e, t) {
            ...
            return e.completers.forEach(function(i, s) {
                i.getCompletions(e, n, r, o,
                function(r, i) { ! r && i && (u = u.concat(i));
        ...
        this.showDocTooltip = function(e) {
            ...
            window.innerWidth - r.right < 320 ? (t.style.right = window.innerWidth - r.left + "px", t.style.left = "") : (t.style.left = r.right + 1 + "px", t.style.right = ""),
