...
function(e) {
    ...
    (p = function(e, t) {
        ...
        i._validate() && (i.isPreviewable = K.hasFileAPISupport(), i.isIE9 = K.isIE(9), i.isIE10 = K.isIE(10), (i.isPreviewable || i.isIE9) && (i._init(t), i._listen()), i.$element.removeClass("file-loading"))
    }).prototype = {
        constructor: p,
        _cleanup: function() {
            var e = this;
        ...
        _init: function(e, t) {
            ...
            o.rtl && (n = o.previewZoomButtonIcons.prev, o.previewZoomButtonIcons.prev = o.previewZoomButtonIcons.next, o.previewZoomButtonIcons.next = n),
            t || o._cleanup(),
            ...
            !o.imageCanvas && o.resizeImage && (o.maxImageWidth || o.maxImageHeight) && (o.imageCanvas = document.createElement("canvas"), o.imageCanvasContext = o.imageCanvas.getContext("2d")),
            ...
            K.isEmpty(o.msgPlaceholder) || (i = l.attr("multiple") ? o.filePlural: o.fileSingle, o.$caption.attr("placeholder", o.msgPlaceholder.replace("{files}", i))),
            ...
            t ? o._errorsExist() || o.$errorContainer.hide() : (o.$errorContainer.hide(), o.previewInitId = "preview-" + K.uniqId(), o._initPreviewCache(), o._initPreview(!0), o._initPreviewActions(), o.$parent.hasClass("file-loading") && (o.$container.insertBefore(o.$parent), o.$parent.remove())),
        ...
        _initTemplateDefaults: function() {
            ...
            q.each(d.defaults,
            function(e, t) {
                "allowedPreviewTypes" !== e ? d[e] = q.extend(!0, {},
                t, d[e]) : void 0 === d.allowedPreviewTypes && (d.allowedPreviewTypes = t)
            }),
        ...
        _initPreviewTemplates: function() {
            ...
            n = r.tagAfter;
            q.each(e.previewContentTemplates,
            function(e, t) {
        ...
        _initPreviewCache: function() {
            ...
            b.previewCache = {
                ...
                add: function(e, t, i, a) {
                    ...
                    a ? (r = n.content.push(e) - 1, n.config[r] = t, n.tags[r] = i) : (r = e.length - 1, n.content = e, n.config = t, n.tags = i),
                ...
                unset: function(e) {
                    ...
                    if (t) {
                        if (1 === t) return b.previewCache.data.content = [],
                ...
                out: function() {
                    ...
                    for (e = 0; e < a; e++) t = b.previewCache.get(e),
                ...
                footer: function(e, t, i) {
                    ...
                    if (K.isEmpty(a.content)) return ""; (K.isEmpty(a.config) || K.isEmpty(a.config[e])) && (a.config[e] = {}),
                    t = void 0 === t || t;
                    var r, n = a.config[e],
                    o = K.ifSet("caption", n),
        ...
        _parseFileType: function(e, t) {
            ...
            for (r = 0; r < n.length; r++) if (a = n[r], i = (0, this.fileTypeSettings[a])(e, t) ? a: "", !K.isEmpty(i)) return i;
            return "other"
        },
        _getPreviewIcon: function(e) {
            var i, a = this,
            r = null;
            return e && -1 < e.indexOf(".") && (i = e.split(".").pop(), a.previewFileIconSettings && (r = a.previewFileIconSettings[i] || a.previewFileIconSettings[i.toLowerCase()] || null), a.previewFileExtSettings && q.each(a.previewFileExtSettings,
            function(e, t) {
        ...
        _listen: function() {
            ...
            e._handler(q(window), "resize",
            function() {
                e._listenFullScreen(screen.width === window.innerWidth && screen.height === window.innerHeight)
            }),
            e._handler(q(document), "webkitfullscreenchange mozfullscreenchange fullscreenchange MSFullscreenChange",
            function() {
        ...
        _initClickable: function() {
            var i, a = this;
            a.isClickable && (i = a.isAjaxUpload ? a.$dropZone: a.$preview.find(".file-default-preview"), K.addCss(i, "clickable"), i.attr("tabindex", -1), a._handler(i, "click",
            function(e) {
                var t = q(e.target);
                q(a.elErrorContainer + ":visible").length || t.parents(".file-preview-thumbnails").length && !t.parents(".file-default-preview").length || (a.$element.trigger("click"), i.blur())
            }))
        },
        ...
        _zoneDragEnter: function(e) {
            ...
            if (this._zoneDragDropInit(e), this.isDisabled || !t) return e.originalEvent.dataTransfer.effectAllowed = "none",
        ...
        _zoneDrop: function(e) {
            ...
            if (e.preventDefault(), !i.isDisabled && !K.isEmpty(n)) if (0 < l) {
        ...
        _clearPreview: function() {
            var e = this,
            t = e.$preview; (e.showUploadedThumbs ? e.getFrames(":not(.file-preview-success)") : e.getFrames()).each(function() {
                var e = q(this);
                e.remove(),
        ...
        _initPreview: function(e) {
            var t, i = this,
            a = i.initialCaption || "";
            if (!i.previewCache.count()) return i._clearPreview(),
        ...
        _initZoom: function() {
            ...
            a = "#" + K.MODAL_ID;
            i.showPreview && (i.$modal = q(a), i.$modal && i.$modal.length || (e = q(document.createElement("div")).html(t).insertAfter(i.$container), i.$modal = q(a).insertBefore(e), e.remove()), K.initModal(i.$modal), i.$modal.html(i._getModalContent()), q.each(K.MODAL_EVENTS,
            function(e, t) {
        ...
        _initZoomButtons: function() {
            ...
            if (a.length < 2) return n.hide(),
            void o.hide();
            n.show(),
            o.show(),
            r && (e = q(a[0]), t = q(a[r - 1]), n.removeAttr("disabled"), o.removeAttr("disabled"), e.length && e.attr("id") === i && n.attr("disabled", !0), t.length && t.attr("id") === i && o.attr("disabled", !0))
        },
        ...
        _resizeZoomDialog: function(e) {
            ...
            if (i.hasClass("file-zoom-fullscreen")) K.toggleFullScreen(!1),
            e ? a.hasClass("active") || (i.removeClass("file-zoom-fullscreen"), t._resizeZoomDialog(!0), r.hasClass("active") && r.removeClass("active").attr("aria-pressed", "false")) : a.hasClass("active") ? a.removeClass("active").attr("aria-pressed", "false") : (i.removeClass("file-zoom-fullscreen"), t.$modal.find(".kv-zoom-body").css("height", t.zoomModalHeight));
            else {
        ...
        _setZoomContent: function(e, t) {
            ...
            t ? (d = o.addClass("file-thumb-loading").clone().insertAfter(o), o.html(r).hide(), d.fadeOut("fast",
            function() {
                o.fadeIn("fast",
                function() {
            ...
            (s = c.previewZoomSettings[a]) && (l = o.find(".kv-preview-data"), K.addCss(l, "file-zoom-detail"), q.each(s,
            function(e, t) {
                l.css(e, t),
            ...
            function() {
                ...
                r = function(e) {
                    ...
                    i = c.zoomModalHeight;
                    u.hasClass("file-zoom-fullscreen") && (i = t.outerHeight(!0), e || (i -= a.outerHeight(!0))),
                    t.css("height", e ? i + e: i)
                };
                a.is(":visible") ? (e = a.outerHeight(!0), a.slideUp("slow",
                function() {
                    i.find(".btn").appendTo(t),
                    r(e)
                })) : (t.find(".btn").appendTo(i), a.slideDown("slow",
                function() {
                    r()
                })),
                u.focus()
            }),
            c._handler(u, "keydown",
            function(e) {
        ...
        _clearFileInput: function() {
            ...
            K.isEmpty(a.files) && K.isEmpty(a.val()) || (a.files = null, e = a.closest("form"), t = q(document.createElement("form")), i = q(document.createElement("div")), a.before(i), e.length ? e.after(t) : i.after(t), t.append(a).trigger("reset"), i.before(a).remove(), t.remove())
        },
        ...
        _initAjaxSettings: function() {
            this._ajaxSettings = q.extend(!0, {},
            this.ajaxSettings),
            this._ajaxDeleteSettings = q.extend(!0, {},
            this.ajaxDeleteSettings)
        },
        _mergeAjaxCallback: function(e, t, i) {
            var a, r = this._ajaxSettings,
            n = this.mergeAjaxCallbacks;
            "delete" === i && (r = this._ajaxDeleteSettings, n = this.mergeAjaxDeleteCallbacks),
            a = r[e],
            r[e] = n && "function" == typeof a ? "before" === n ?
            function() {
        ...
        _checkAsyncComplete: function() {
            var e, t, i = this;
            for (t = 0; t < i.filestack.length; t++) if (i.filestack[t] && (e = i.previewInitId + "-" + t, -1 === q.inArray(e, i.uploadLog))) return ! 1;
        ...
        _uploadSingle: function(n, o) {
            ...
            f.formdata = h,
            f.showPreview && (l = q("#" + g + ":not(.file-preview-initial)"), s = l.find(".kv-file-upload"), t = l.find(".kv-file-remove"), w.show()),
            ...
            e = function() {
                ...
                f.fileBatchCompleted && (o && o.content && (n = o.content.length), setTimeout(function() {
                    ...
                    if (f.showPreview) {
                        ...
                        } else f.initialPreview = r.content,
                        f.initialPreviewConfig = r.config,
                        f.initialPreviewThumbTags = r.tags;
                        f.cacheInitialPreview = {},
                        f.hasInitData && (f._initPreview(), f._initPreviewActions())
                    }
                    f.unlock(e),
                    e && f._clearFileInput(),
                    t = f.$preview.find(".file-preview-initial"),
                    f.uploadAsync && t.length && (K.addCss(t, K.SORT_CSS), f._initSortable()),
            ...
            i = function(e) {
                ...
                o || (f.ajaxAborted = !1),
                f.showPreview && (l.hasClass("file-preview-success") || (f._setThumbStatus(l, "Loading"), K.addCss(l, "file-uploading")), s.attr("disabled", !0), t.attr("disabled", !0)),
                o || f.lock(),
                f._raise("filepreupload", [r, g, n]),
                q.extend(!0, _, r),
                f._abort(_) && (e.abort(), o || (f._setThumbStatus(l, "New"), l.removeClass("file-uploading"), s.removeAttr("disabled"), t.removeAttr("disabled"), f.unlock()), f._setProgressCancelled())
            },
            a = function(e, t, i) {
            ...
            c = function() {
                setTimeout(function() {
                    f.showPreview && (s.removeAttr("disabled"), t.removeAttr("disabled"), l.removeClass("file-uploading")),
                    o ? e() : (f.unlock(!1), f._clearFileInput()),
        ...
        _uploadBatch: function() {
            ...
            e = function(e) {
                ...
                s.showPreview && s._getThumbs().each(function() {
                    ...
                    e.hasClass("file-preview-success") || (s._setThumbStatus(e, "Loading"), K.addCss(e, "file-uploading")),
                    t.attr("disabled", !0),
                    i.attr("disabled", !0)
                }),
                s._raise("filebatchpreupload", [t]),
                s._abort(t) && (e.abort(), s._getThumbs().each(function() {
                    var e = q(this),
                    t = e.find(".kv-file-upload"),
                    i = e.find(".kv-file-remove");
                    e.hasClass("file-preview-loading") && (s._setThumbStatus(e, "New"), e.removeClass("file-uploading")),
            ...
            t = function(e, t, i) {
                ...
                K.isEmpty(e) || K.isEmpty(e.error) ? (s._raise("filebatchuploadsuccess", [a]), l(), s.showPreview ? (n.each(function() {
                    ...
                    0 === o.length || -1 !== q.inArray(r, o) ? (s._setPreviewError(e, t, s.filestack[t], s.retryErrorUploads), s.retryErrorUploads || (e.find(".kv-file-upload").hide(), s.updateStack(t, void 0))) : (e.find(".kv-file-upload").hide(), s._setThumbStatus(e, "Success"), s.updateStack(t, void 0)),
            ...
            c.showPreview && (c._initZoomButton(), c.getFrames(" .kv-file-remove").each(function() {
                ...
                function() {
                    ...
                    function() {
                        ...
                        c._clearObjects(l),
                        l.remove(),
                        s && r && c.$errorContainer.find('li[data-file-id="' + s + '"]').fadeOut("fast",
                        function() {
                            q(this).remove(),
                        ...
                        0 !== i || 0 !== t || a ? (o = 1 < (n = t + i) ? c._getMsgSelected(n) : e[0] ? c._getFileNames()[0] : "", c._setCaption(o)) : c.reset(),
            ...
            m.find(e).each(function() {
                ...
                if (!K.isEmpty(a) && void 0 !== o) {
                    ...
                    e = function(e) {
                        ...
                        f._abort() ? e.abort() : (n.removeClass(v), K.addCss(c, "file-uploading"), K.addCss(n, "disabled " + g))
                    },
                    t = function(e, t, i) {
                        var a, r;
                        if (!K.isEmpty(e) && !K.isEmpty(e.error)) return l.jqXHR = i,
                        l.response = e,
        ...
        _generatePreviewTemplate: function(l, e, s, d, c, t, i, p, a, u, f) {
            ...
            r = function(e, t, i, a) {
                ...
                "object" !== l || d || q.each(m.defaults.fileTypeSettings,
                function(e, t) {
        ...
        _previewFile: function(e, a, t, r, i, n) {
            if (this.showPreview) {
                ...
                if ("html" === p && l.purifyHtml && window.DOMPurify && (w = window.DOMPurify.sanitize(w)), g || v) {
                    ...
                    l._addToPreview(m, o);
                    var _ = m.find("#" + r + " img");
                    _.length && l.autoOrientImage ? K.validateOrientation(a,
                    function(e) {
                        if (e) {
        ...
        _setInitThumbAttr: function() {
            ...
            if (0 !== n) for (var o = 0; o < n; o++) e = r.config[o],
        ...
        _updateFileDetails: function(e) {
            ...
            t.isError ? (t.$previewContainer.removeClass("file-thumb-loading"), t.$previewStatus.html(""), t.$captionContainer.removeClass("icon-visible")) : t._showFileIcon(),
        ...
        _setFileDropZoneTitle: function() {
            ...
            a = t.dropZoneTitle;
            t.isClickable && (e = K.isEmpty(t.$element.attr("multiple")) ? t.fileSingle: t.filePlural, a += t.dropZoneClickTitle.replace("{files}", e)),
            i.find("." + t.dropZoneTitleClass).remove(),
            !t.showPreview || 0 === i.length || 0 < t.getFileStack().length || !t.dropZoneEnabled || !t.isAjaxUpload && t.$element.files || (0 === i.find(K.FRAMES).length && K.isEmpty(t.defaultPreviewContent) && i.prepend('<div class="' + t.dropZoneTitleClass + '">' + a + "</div>"), t.$container.removeClass("file-input-new"), K.addCss(t.$container, "file-input-ajax-new"))
        },
        _setAsyncUploadStatus: function(e, t, i) {
            var a = 0;
            this._setProgress(t, q("#" + e).find(".file-thumb-progress")),
            this.uploadStatus[e] = t,
            q.each(this.uploadStatus,
            function(e, t) {
                a += t
            }),
        ...
        _setPreviewError: function(e, t, i, a) {
            ...
            r.showPreview && (!r.removeFromPreviewOnError || a ? (r._setThumbStatus(e, "Error"), r._refreshUploadButton(e, a)) : e.remove())
        },
        ...
        _checkDimensions: function(e, t, i, a, r, n, o) {
            var l, s, d, c = this[("Small" === t ? "min": "max") + "Image" + n]; ! K.isEmpty(c) && i.length && (d = i[0], s = "Width" === n ? d.naturalWidth || d.width: d.naturalHeight || d.height, ("Small" === t ? c <= s: s <= c) || (l = this["msgImage" + n + t].setTokens({
                name: r,
                size: c
        ...
        _validateImage: function(e, t, i, a, r) {
            ...
            function() {
                ...
                s.resizeImage || (s._checkDimensions(p, "Large", u, c, t, "Width", n), s._checkDimensions(p, "Large", u, c, t, "Height", n)),
        ...
        _validateAllImages: function() {
            ...
            if (n === a.totalImagesCount && (a._raise("fileimagesloaded"), a.resizeImage)) for (e = 0; e < a.loadedImages.length; e++)(t = a.loadedImages[e]).validated || ((i = t.siz) && 1e3 * o < i && a._getResizedImage(t, r, n), a.loadedImages[e].validated = !0)
        },
        _getResizedImage: function(e, t, i) {
            ...
            d.filestack[C] && g && !(p <= m && u <= h) || (g && d.filestack[C] && d._raise("fileimageresized", [b, C]), t.val++, t.val === i && d._raise("fileimagesresized"), g)) {
                ...
                try {
                    ...
                    x && (s = window.piexif.dump(x), o = window.piexif.insert(s, o)),
                    a = K.dataURI2Blob(o),
                    d.filestack[C] = a,
        ...
        _setCaption: function(e, t) {
            ...
            s = l.getFileStack();
            if (l.$caption.length) {
                if (l.$captionContainer.removeClass("icon-visible"), t) i = q("<div>" + l.msgValidationError + "</div>").text(),
        ...
        _change: function(e) {
            ...
            if (!i.changeTriggered) {
                ...
                C = i._getFileIds();
                if (i.reader = null, i._resetUpload(), i._hideFileIcon(), i.dropZoneEnabled && i.$container.find(".file-drop-zone ." + i.dropZoneTitleClass).remove(), h ? q.each(v,
                function(e, t) {
                    i._filterDuplicate(t, g, C)
                }) : (v = e.target && void 0 === e.target.files ? e.target.value ? [{
                    name: e.target.value.replace(/^.+\\/, "")
                }] : [] : e.target.files || {},
                g = v), K.isEmpty(g) || 0 === g.length) return h || i.clear(),
                void i._raise("fileselectnone");
                if (i._resetErrors(), a = g.length, t = i._getFileCount(h ? i.getFileStack().length + a: a), 0 < w && w < t) {
                    if (!i.autoReplace || w < a) return r = i.autoReplace && w < a ? a: t,
                    n = w,
                    u = i.msgFilesTooMany.replace("{m}", n).replace("{n}", r),
                    i.isError = (o = u, d = s = l = null, c = q.extend(!0, {},
                    i._getOutData({},
                    {},
                    v), {
                        id: s,
        ...
        _abort: function(e) {
            ...
            i._getOutData(), e)).abortData = i.ajaxAborted.data || {},
            t.abortMessage = i.ajaxAborted.message, i._setProgress(101, i.$progress, i.msgCancelled), i._showUploadError(i.ajaxAborted.message, t, "filecustomerror"), i.cancel(), !0) : !!i.ajaxAborted
        },
        ...
        _isFileSelectionValid: function(e) {
            var t = this;
            return e = e || 0,
            t.required && !t.getFilesCount() ? (t.$errorContainer.html(""), t._showUploadError(t.msgFileRequired), !1) : !(0 < t.minFileCount && t._getFileCount(e) < t.minFileCount) || (t._noFilesError({}), !1)
        },
        clearStack: function() {
        ...
        readFiles: function(S) {
            ...
            M = L ? L.length: 0,
            Z = F.allowedFileExtensions,
            N = K.isEmpty(Z) ? "": Z.join(", "),
            ...
            W = function(e, t, i, a) {
                ...
                F.isAjaxUpload ? (F.addToStack(void 0), setTimeout(function() {
                    k(a + 1)
                },
                100)) : B = 0,
                F._initFileActions(),
            ...
            (k = function(c) {
                if (K.isEmpty(P.attr("multiple")) && (B = 1), B <= c) return F.isAjaxUpload && 0 < F.filestack.length ? F._raise("filebatchselected", [F.getFileStack()]) : F._raise("filebatchselected", [S]),
                ...
                _ = O.image,
                b = O.html,
                C = v.name ? F.slug(v.name) : "",
                l = (v.size || 0) / 1e3,
                s = "",
                y = K.objUrl.createObjectURL(v),
                d = 0,
                x = "",
                T = 0,
                E = function() {
                ...
                if (0 < M) for (p = 0; p < M; p++) r = L[p],
                n = F.msgFileTypes[r] || r,
                x += 0 === p ? n: ", " + n;
                if (!1 !== C) {
                    if (0 === C.length) return a = F.msgInvalidFileName.replace("{name}", K.htmlEncode(v.name)),
                    void W(a, v, g, c);
                    if (K.isEmpty(Z) || (s = new RegExp("\\.(" + Z.join("|") + ")$", "i")), e = l.toFixed(2), 0 < F.maxFileSize && l > F.maxFileSize) return a = F.msgSizeTooLarge.setTokens({
                        name: C,
                        size: e,
                    ...
                    if (0 === d && !K.isEmpty(Z) && K.isArray(Z) && !K.isEmpty(s) && (i = K.compare(C, s), 0 === (d += K.isEmpty(i) ? 0 : i.length))) return a = F.msgInvalidFileExtension.setTokens({
                        name: C,
                        extensions: N
                    }),
                    void W(a, v, g, c);
                    if (!F.showPreview) return F.isAjaxUpload && F.addToStack(v),
                    setTimeout(function() {
                        k(c + 1),
                        F._updateFileDetails(B)
                    },
                    ...
                    if (!V && H < l) return F.addToStack(v),
                    D.addClass("file-thumb-loading"),
                    F._previewDefault(v, g),
                    F._initFileActions(),
                    F._updateFileDetails(B),
                    void k(c + 1);
                    I.length && void 0 !== FileReader ? (u = w(v.type, C), f = b(v.type, C), m = _(v.type, C), $.html(z.replace("{index}", c + 1).replace("{files}", B)), D.addClass("file-thumb-loading"), A.onerror = function(e) {
                        F._errorHandler(e, C)
                    },
                    A.onload = function(e) {
                        ...
                        function(e, t) {
                            ...
                            for (a = new Uint8Array(e.target.result), p = 0; p < a.length; p++) r = a[p].toString(16),
                            d.push(r);
                            ...
                            u = w(o, ""), f = b(o, ""), m = _(o, ""), (h = u || f) || m) return l = h,
        ...
        cancel: function() {
            ...
            t = i.ajaxRequests,
            a = t.length;
            if (0 < a) for (e = 0; e < a; e += 1) i.cancelling = !0,
            t[e].abort();
            ...
            i._getThumbs().each(function() {
                ...
                t = e.attr("data-fileindex");
                e.removeClass("file-uploading"),
                void 0 !== i.filestack[t] && (e.find(".kv-file-upload").removeClass("disabled").removeAttr("disabled"), e.find(".kv-file-remove").removeClass("disabled").removeAttr("disabled")),
                i.unlock()
            }),
            i.$element
        },
        clear: function() {
            var e, t = this;
            if (t._raise("fileclear")) return t.$btnUpload.removeAttr("disabled"),
            ...
            t._clearFileInput(),
            t._resetErrors(!0),
            t._hasInitialPreview() ? (t._showFileIcon(), t._resetPreview(), t._initPreviewActions(), t.$container.removeClass("file-input-new")) : (t._getThumbs().each(function() {
                t._clearObjects(q(this))
            }), t.isAjaxUpload && (t.previewCache.data = {}), t.$preview.html(""), e = !t.overwriteInitial && 0 < t.initialCaption.length ? t.initialCaption: "", t.$caption.attr("title", "").val(e), K.addCss(t.$container, "file-input-new"), t._validateDefaultPreview()),
        ...
        upload: function() {
            ...
            if (a.isAjaxUpload && !a.isDisabled && a._isFileSelectionValid(r)) if (a._resetUpload(), 0 !== r || n) if (a.$progress.show(), a.uploadCount = 0, a.uploadStatus = {},
            a.uploadLog = [], a.lock(), a._setProgress(2), 0 === r && n) a._uploadExtraOnly();
            else {
                if (i = a.filestack.length, a.hasInitData = !1, !a.uploadAsync) return a._uploadBatch(),
                a.$element;
                ...
                a.uploadAsyncCount = a.getFileStack().length, e = 0; e < i; e++) a.uploadCache.content[e] = null,
        ...
        refresh: function(e, t) {
            var i = this,
            a = i.$element;
            return e = "object" != typeof e || K.isEmpty(e) ? i.options: q.extend(!0, {},
            i.options, e),
            i._init(e, !0),
            i._listen(),
    ...
    q.fn.fileinput = function(s) {
        if (K.hasFileAPISupport() || K.isIE(9)) {
            ...
            switch (d.shift(), this.each(function() {
                ...
                i || (r && (o = q.fn.fileinputThemes[r] || {}), "en" === l || K.isEmpty(q.fn.fileinputLocales[l]) || (n = q.fn.fileinputLocales[l] || {}), e = q.extend(!0, {},
                q.fn.fileinput.defaults, o, q.fn.fileinputLocales.en, n, a, t.data()), i = new p(this, e), t.data("fileinput", i)),
