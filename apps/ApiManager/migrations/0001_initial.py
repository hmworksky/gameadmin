# Generated by Django 2.0.3 on 2019-01-08 15:16
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('belong_module', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='apps.ApiManager.ModuleInfo')),
            ],
            options={
                'verbose_name': '用例信息',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('belong_project', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='apps.ApiManager.ProjectInfo')),
            ],
            options={
                'verbose_name': '用例集合',
                'db_table': 'TestSuite',
