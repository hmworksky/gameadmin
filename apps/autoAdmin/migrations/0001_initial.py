# Generated by Django 2.1.3 on 2019-03-24 12:59
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('memo', models.CharField(default='', max_length=2000, null=True)),
            ],
            options={
                'verbose_name': '渠道表',
                'db_table': 'channel',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('belong_module', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='autoAdmin.ModuleInfo')),
            ],
            options={
                'verbose_name': '用例信息',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('belong_project', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='autoAdmin.ProjectInfo')),
            ],
            options={
                'verbose_name': '用例集合',
                'db_table': 'TestSuite',
        ...
        migrations.AddField(
            ...
            name='belong_project',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='autoAdmin.ProjectInfo'),
        ),
        migrations.AddField(
